...
% ============================================================
\section{Una mappa dei candidati per il Veneto}
% ============================================================

Incrociando i quattro tipi di attrattore con le morfologie disponibili nel territorio veneto e con il quadro delle aree non ancora sistematicamente investigate, emergono cinque zone prioritarie. Non sono le uniche possibili, ma sono quelle dove la combinazione di morfologia favorevole e lacuna documentata nella letteratura è più netta.

La \textbf{Lessinia settentrionale e orientale} (tra Sant'Anna d'Alfaedo, Vajo dell'Anguilla e Roverè Veronese) presenta pareti calcaree verticali nella fascia seicento-novecentometri con morfologia adatta all'età del bronzo, pianori carsici con superfici subpianeggianti adatte alle coppelle, e valli convergenti verso la pianura veronese. La ricerca preistorica in Lessinia ha dato ottimi risultati per il Paleolitico e per l'archeozoologia (Grotta di Fumane, Riparo Tagliente), ma non risulta orientata specificamente alla ricerca di arte rupestre a quote di mezza montagna.

Il \textbf{Cansiglio} ha una base di conoscenza già solida (trent'anni di ricerche dell'Università di Ferrara sulla frequentazione preistorica), ma la ricerca specifica sull'arte rupestre non è mai stata il target principale. Un programma dedicato ai segni incisi o dipinti, partendo dalla mappa delle frequentazioni già documentate, potrebbe fare emergere arte rupestre in un contesto già noto per la sua ricchezza di materiale preistorico.

I \textbf{passi delle Dolomiti cadorine} (Passo Duran, Passo Cereda, Passo di Giau, Forcella Valbona) sono candidati per il Mesolitico e l'Eneolitico: morfologie di valico con più direttrici, quote adeguate, acqua disponibile nei circhi glaciali circostanti. Il Cadore ha già dimostrato (Mondeval, Val Visdende, Pian dei Buoi) che la frequentazione preistorica di quota è intensa e sottostimata: estendere quella ricerca con attenzione specifica all'arte rupestre è il passo logico successivo.

Il \textbf{versante meridionale del Grappa} (tra Romano d'Ezzelino, Pove del Grappa e Semonzo) presenta calcare affiorante in pareti verticali nella fascia quattrocento-ottocento metri, con morfologie adatte all'età del bronzo. Il massiccio del Grappa non risulta indagato per arte rupestre preistorica e, a differenza del versante sommitale, il versante meridionale non è stato interessato dai combattimenti della Prima guerra mondiale. È il caso più netto di lacuna non spiegabile con la morfologia o con la storia della ricerca locale.

La \textbf{fascia prealpina trevigiana} (Col Visentin, Cesen, Monte Cesen, Monte Perdòn verso Vittorio Veneto) presenta morfologie calcaree e dolomitiche nella fascia quattrocento-milleduecento metri, in una zona di transizione tra l'ambiente prealpino e le Dolomiti bellunesi, storicamente percorsa da vie di comunicazione tra pianura e montagna. La ricerca preistorica in questa fascia è quasi assente nella letteratura consultata; la morfologia è compatibile con arte rupestre dell'età del bronzo e con coppelle neolitiche.

Queste cinque aree non coprono tutto il territorio, e non si tratta di previsioni: si tratta di ipotesi verificabili. La verifica richiede quello che questo libro non sostituisce, il lavoro sul campo, ma ne può orientare la direzione, suggerendo dove abbia più senso iniziare.
