...
% ============================================================
\section{Venezia: la Laguna, la terraferma e il litorale}
% ============================================================

% SEGNAPOSTO: risultati ricerca in corso

\emph{Sezione in preparazione. La ricerca bibliografica sulla provincia di Venezia è in corso al momento della stesura di questo capitolo; i risultati saranno integrati in una versione successiva.}

I punti principali attesi dalla letteratura: siti paleolitici assenti per le stesse ragioni geomorfologiche del Polesine (pianura alluvionale e laguna recente); siti neolitici e dell'età del bronzo su dossi fluviali in terraferma veneziana; Mestre e dintorni come area con ritrovamenti sporadici di età preistorica; la gronda lagunare con insediamenti paleoveneti; Concordia Sagittaria come sito chiave per il distretto nordorientale. Arte rupestre strutturalmente assente nell'area lagunare e costiera; zona di transizione con il Friuli verso nord.
