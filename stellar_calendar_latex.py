...
SEASON_ABBR = {
    ...
    "Nascita dei piccoli (stambecco, camoscio, cervo)":  "\\textsc{nascite}",
...
def build_preamble() -> list[str]:
    return [
        ...
        "tutte le epoche. \\textsc{disgelo}, \\textsc{prima neve} e \\textsc{nascite} si",
        "applicano solo al Paleolitico medio/superiore; \\textsc{salita}, \\textsc{discesa},",
        "\\textsc{bramito} e \\textsc{camoscio} solo al Mesolitico; \\textsc{sem.pri},",
        "\\textsc{sem.aut} e \\textsc{mietit.} solo dal Neolitico all'età del Ferro",
        "(vedi colonna Periodo).",
        ...
        "\\textsc{disgelo} Disgelo dei fiumi (g.~25);",
        "\\textsc{prima neve} Prime nevicate in pianura/collina (g.~225);",
        "\\textsc{nascite} Nascita dei piccoli, stambecco/camoscio/cervo (g.~85);",
        "\\textsc{salita} Salita stagionale in quota (g.~65);",
        "\\textsc{discesa} Discesa a valle, fine stagione d'alta quota (g.~225);",
